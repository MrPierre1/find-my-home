...
// import test from './assets/realtor1';
...
function ContactRealtor (props) {
  ...
  const handleSubmit = (data) => {
    console.log('email, phone, name', name, email, phone)
  }
    ...
    return (
      <div>
        ...
        <Modal dimmer={'blurring'} size="large"  open={isOpen} onClose={() => setisOpen(false)}>
...
<Divider></Divider>
    ...
    <Modal.Actions>
        <Button primary type='submit'>Connect with an agent</Button>   
